...
public final class GeneratedPluginRegistrant {
  ...
  public static void registerWith(@NonNull FlutterEngine flutterEngine) {
    ...
    try {
      flutterEngine.getPlugins().add(new com.nateshmbhat.credit_card_scanner.CardScannerPlugin());
    } catch(Exception e) {
      Log.e(TAG, "Error registering plugin credit_card_scanner, com.nateshmbhat.credit_card_scanner.CardScannerPlugin", e);
    }
    try {
